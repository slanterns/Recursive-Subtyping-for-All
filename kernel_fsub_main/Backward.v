...
Lemma subst_label_rt_type : forall Z T,
  rt_type T ->
  rt_type (subst_label Z T).
Proof with auto.
  intros.
  induction H...
  constructor...
...
Lemma subst_label_collect: forall E T i X,
    ...
    i `notin` collectLabel (subst_label X T).
Proof with auto.
  intros.
...
Lemma subst_label_collect2: forall E T i X,
    rt_type T ->
    WF E T ->
...
Lemma subst_label_collect3: forall E T i X,
    rt_type T ->
    WF E T ->
    i `in` collectLabel T ->
    i `in` collectLabel (subst_label X T).
...
Lemma Tlookup_subst_label: forall T i X t ,
    ...
    exists t', t = subst_label X t' /\ Tlookup i T = Some t'.
Proof with auto.
  induction T;simpl;intros;try solve [inversion H]...
...
Proof with eauto. 
  ...
  - apply sa_and_b... apply WF_drop_label...
    ...
    + constructor...
      { apply wf_env_drop_label... }
      { simpl. apply KeySetProperties.subset_empty. }
      { apply WF_drop_label in H3 ... }
      { intros. inversion H1. }
    + simpl in H2. specialize (H2 i).
      exfalso. apply notin_empty_1 with (x:=i)...
    + constructor...
      { apply wf_env_drop_label... }
      { simpl in H2. simpl...
        intros x. intros.
        specialize (H2 x). apply union_iff in H0. apply union_iff.
        destruct H0.
        + apply union_iff in H2... destruct H2... right.
          eapply subst_label_collect3...
          { dependent destruction H3... }
          { dependent destruction H3... }
        + apply union_iff in H2... 
          2:{ apply union_iff... right.
              eapply subst_label_collect2...
      ...
      { apply WF_drop_label in H3 ... }
      { apply WF_drop_label in H4 ... }
      { intros.
        destruct (Tlookup_subst_label (typ_rcd_cons i T1 T2) i1 X (t:=t1))
          as [t1' [? ?]]... subst t1.
        destruct (Tlookup_subst_label (typ_rcd_cons i0 T0 T3) i1 X (t:=t2))
            as [t2' [? ?]]... subst t2.
