...
Proof with auto.
  ...
  exists X0...
Abort.
(* does not hold, sub E (typ_and U B) X -\> exists Y, (typ_and U B) = typ_fvar Y *)
...
Proof with auto.
  ...
  -
    ...
    apply KeySetProperties.union_subset_3...
      -- eapply IHT1.
        --- apply notin_union. apply notin_union in H. apply notin_union in H2. destruct_hypos. split...
        --- apply H0.
      -- eapply IHT2.
        --- apply notin_union. apply notin_union in H, H2. destruct_hypos. split...
        --- apply H1.
    (* apply dom_split_2 in H0...
    eapply IHT1. auto. apply H0.
    apply H1.
    apply union_subset_7 in H1...
    destruct_hypos.
    apply KeySetProperties.union_subset_3...
    apply IHT1 with (X:=X) (n:=n)...
    apply IHT2 with (X:=X) (n:=n)... *)
